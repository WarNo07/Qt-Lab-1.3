...
static const char qt_meta_stringdata_FirstWindow[] = {
    "FirstWindow\0\0on_pushButton_13_clicked()\0"
...
const QMetaObjectExtraData FirstWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FirstWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FirstWindow,
      qt_meta_data_FirstWindow, &staticMetaObjectExtraData }
};
